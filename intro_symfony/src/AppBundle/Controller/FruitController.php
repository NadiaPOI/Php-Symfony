...
class FruitController extends Controller {
  ...
  */
  public function ajaxListFruitsAction(){
    ...
    // Problème json_encode ne peut encoder des objets PHP
    // json_encode fonctionne avec des tableauc associatifs
    ...
    foreach($fruits as $fruit) {
      ...
      $fruits_assoc[] = $fruit_assoc; // equivalent d'un array_push
    }
    // encodage en json du tableau associatifs
